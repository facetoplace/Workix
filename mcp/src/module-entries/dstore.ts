...
export async function fetchJobs(_ctx: AdapterContext) {
  return {
    jobs: [],
    error:
      "optional: dStore is an app catalog. Use workix_dstore_search / _publish / _similar (or dstore-mcp).",
  };
}
...
export {
  ...
  dstoreSearch as search,
  dstoreSimilar as similar,
  dstoreQuota as quota,
  dstoreGetList as getList,
  DSTORE_DOCS,
};
