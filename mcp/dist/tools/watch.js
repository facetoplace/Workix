const SOURCES = {
    profi: {
        ...
        checklist: [
            "Залогинься в Profi.",
            "Кабинет → новые заказы / заявки — 5 релевантных IT/продукт со ссылками.",
    ...
    avito: {
        name: "Avito Услуги",
        open_url: "https://www.avito.ru/",
        kind: "service",
        value: "RU services / private clients",
        checklist: [
            "Залогинься в Avito (ToS: только полуручной режим).",
            "Услуги / заказы / сообщения — 5 релевантных лидов со ссылками на объявление или чат.",
    ...
    fiverr: {
        ...
        checklist: [
            ...
            "Гейт: если редирект на /seller_onboarding/overview — сначала завершить Seller Onboarding (CV/LinkedIn PDF или ручной профиль), потом ≥1 active Gig + Get Briefs (min rate).",
            ...
            "Capture: workix_get_job url+platform=fiverr+title(+description) → draft → workix_prepare_browser_apply. Не жать Send/Create Offer без «ок».",
